...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MobileSecurityService
...
func newPodForCR(cr *mobilesecurityservicev1alpha1.MobileSecurityService) *corev1.Pod {
