...
This operator was developed using the k8s APIs and should work well in Kubernetes and OpenShift clusters. However, it has been tested so far only on OpenShift clusters.
